...
export class glyph extends Message<glyph> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 2, name: "bitmap", kind: "scalar", T: 12 /* ScalarType.BYTES */, opt: true },
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): glyph {
    return new glyph().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): glyph {
    return new glyph().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): glyph {
    return new glyph().fromJsonString(jsonString, options);
  }

  static equals(a: glyph | PlainMessage<glyph> | undefined, b: glyph | PlainMessage<glyph> | undefined): boolean {
...
export class fontstack extends Message<fontstack> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): fontstack {
    return new fontstack().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): fontstack {
    return new fontstack().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): fontstack {
    return new fontstack().fromJsonString(jsonString, options);
  }

  static equals(a: fontstack | PlainMessage<fontstack> | undefined, b: fontstack | PlainMessage<fontstack> | undefined): boolean {
...
export class glyphs extends Message<glyphs> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): glyphs {
    return new glyphs().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): glyphs {
    return new glyphs().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): glyphs {
    return new glyphs().fromJsonString(jsonString, options);
  }

  static equals(a: glyphs | PlainMessage<glyphs> | undefined, b: glyphs | PlainMessage<glyphs> | undefined): boolean {
